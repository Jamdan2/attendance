...
import SignUpDialogPresentation from './presentation';
...
const SignUpDialogContainer = connect(mapStateToProps, mapDispatchToProps, mergeProps)(SignUpDialogPresentation);
